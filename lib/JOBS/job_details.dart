...
import 'package:fiverr/Widgets/comments_widget.dart';
...
class _JobDetailsScreenState extends State<JobDetailsScreen> {
  ...
  void getJobData() async {
    ...
    if (jobDatabase == null) {
      ...
      setState(() {
        ...
        applocants = jobDatabase.get("applocants");
  ...
  applyForJob() {
    final Uri params = Uri(
      ...
      path: emailCompany,
      query:
          'subject=Applying fro $jobTitle&body=Hello,please attach Reume CV file',
    );
        ...
        appBar: AppBar(
          flexibleSpace: Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [Colors.pinkAccent, Colors.redAccent.shade100],
                begin: Alignment.centerLeft,
                end: Alignment.centerRight,
                stops: const [0.2, 0.9],
              ),
